 ...
 */
declare function createQ402Middleware(config: Q402MiddlewareConfig): MiddlewareHandler<{
    Variables: {
 ...
 */
declare function create402Response(config: Q402MiddlewareConfig, endpoint: PaymentEndpointConfig, _c: Context): PaymentRequiredResponse;
/**
 * Send 402 Payment Required response
 */
declare function send402Response(c: Context, config: Q402MiddlewareConfig, endpoint: PaymentEndpointConfig): Response;

export { type PaymentContext, type PaymentEndpointConfig, type Q402MiddlewareConfig, create402Response, createQ402Middleware, send402Response };
