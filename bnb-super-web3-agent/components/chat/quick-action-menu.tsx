  ...
  const actions = [
    {
      id: "contract-address",
      icon: FileCode,
      label: "Provide Contract Address",
      color: "bg-blue-100 text-blue-600",
    },
    {
      id: "paste-code",
      icon: Code,
      label: "Paste Contract Code",
      color: "bg-purple-100 text-purple-600",
    },
    {
      id: "upload-abi",
      icon: FileJson,
      label: "Upload ABI / JSON",
    ...
    <div className="absolute bottom-full left-0 mb-2 bg-white rounded-xl shadow-lg border border-gray-200 p-2 min-w-[220px]">
      ...
      <div className="space-y-1">
        {actions.map((action) => (
          ...
          >
            <div
              className={`w-8 h-8 rounded-full flex items-center justify-center ${action.color}`}
            >
